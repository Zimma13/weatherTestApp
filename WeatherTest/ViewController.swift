...
class ViewController: UIViewController {
    ...
    func reloadView() {
        ...
        // DarkSkyAPI
        let urlWeather = "https://api.darksky.net/forecast/a372fa32aad2af35aadfff8564fa80b8/\(coordinateArray[cityCount.cityChoise].lat),\(coordinateArray[cityCount.cityChoise].lon)/?units=si&lang=ru"
    ...
    func loadCityFromCoreData() {
        ...
        if coordinateArray.isEmpty {
            ...
            if CoreData.saveCityCoordinate(name: "Москва", lon: 55.755826, lat: 37.6172999) {
